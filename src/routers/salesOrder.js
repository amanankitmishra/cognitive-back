...
router.post("/salesOrders", auth, async (req, res) => {
    try {
...
router.get("/salesOrders", auth, async (req, res) => {
    try {
...
router.get("/salesOrders/:id", auth, async (req, res) => {
    try {
...
router.patch("/salesOrders/:id", auth, async (req, res) => {
...
router.delete("/salesOrders/:id", auth, async (req, res) => {
    try {
